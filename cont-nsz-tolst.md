...
После настройки всех требуемых атрибутов, пользователь может произвести, при необходимости, настройку колонок через функцию  :
 
Рисунок 11. Настройка колонок модели объектов передачи данных

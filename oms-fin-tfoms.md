<!-- TITLE: АИС "ОМС Финанс" с правами Территориальный фонд ОМС-->
...
Далее на форме создания «Раздела финансового плана» пользователю необходимо поставить галочку **<Разбивать по возрастным группам>**, чтобы появилась вкладка **<Настройки групп>**. 

![73](/uploads/001/73.png "73")

Данная вкладка необходима для передачи значений тарифов оказываемых услуг из справочника <Тарифы\Базовые ставки>  по группам например, «Взрослые», «Дети», «Все», «Количество» при расчете финансового плана.
Чтобы добавить условие пользователю во вкладке **<Настройка групп>** необходимо нажать ![67 1](/uploads/001/67-1.png "67 1") на панели инструментов, затем выбрать соответствующую возрастную группу, как показано на рисунке ниже.
...
Далее, в появившемся окне пользователю в поле <Применить для> необходимо выбрать «Тариф», а после с помощью фильтров нужно сформировать условия для каждой возрастной группы, пример заполнения показан на Рисунке ниже.

![76](/uploads/001/76.png "76")

Далее нажать <Ok> и сохранить данный раздел планирования.
Значения тарифов по возрастным группам будут отображены в табличной форме финансового плана, колонки которого содержат значения «Тарифы», как показано на рисунке ниже.

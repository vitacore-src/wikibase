...
## 	Создание шаблона структуры группировщика
Структура группировщика соответствует заголовкам, отображаемым в оси отчета, и описывается с помощью формы редактирования, показанной на Рис. 4.5.

![26](/uploads/0-gen-otch/26.png "26")  ![27](/uploads/0-gen-otch/27.png "27")

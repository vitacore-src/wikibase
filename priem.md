...
![24](/uploads/0-priem-otdel/24.png "24")

Отмечаем галочками все необходимые для печати шаблоны, нажимаем «Печать документов». Если номер истории болезни еще не присвоен, то выходит форма получения очередного номера истории болезни. Нажимаем на кнопку «Получить очередной номер» и номер присваивается автоматически.

Можно ввести номер истории болезни вручную (не рекомендуется!!)

![25](/uploads/0-priem-otdel/25.png "25")
# Отказ от госпитализации


Оформляется нажатием кнопки «Отказ от госпитализации»  на форме создания случая госпитализации

![26](/uploads/0-priem-otdel/26.png "26")

Заполняем причину отказа (причину выбираем из предложенного списка), вид отказа, выбираем врача.

![27](/uploads/0-priem-otdel/27.png "27")
...
![28](/uploads/0-priem-otdel/28.png "28")

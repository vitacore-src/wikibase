...
||Значение функции	|Число	|Число	|Вычисление математической функции. Руководство содержит описание наиболее употребительных функций:<br>•	Получение абсолютного значения (п.2.5.6)|
...
||Существует	|Сущ-ность	|Логический	|Функция позволяет проверить факт существования данных сущности, удовлетворяющих определенным условиям.Применение функции описано в п.2.6.3.|

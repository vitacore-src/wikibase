...
Если в выражении используется большое количество пользовательских параметров (см. п. 2.3.4) существует возможность настраивать порядок их ввода для удобства пользователя – например, их можно сгруппировать по типам. Для этого предназначена кнопка  ![115](/uploads/000003/115.png "115") управляющей панели генератора. Эта кнопка доступна, только если в редактируемом выражении присутствуют пользовательские параметры.

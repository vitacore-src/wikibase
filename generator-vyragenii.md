...
Значение добавленного таким образом параметра будет запрашиваться у пользователя системы с помощью диалога запроса параметров [см. Базовое руководство пользователя](#b18).

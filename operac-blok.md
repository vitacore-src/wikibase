...
# Планирование операций в стационаре
В приемном покое по кнопке Госпитализация создать назначение (направление на операцию), для этого перейти на кнопку Назначения и добавить оперативное вмешательство (примечание: связь Отделения и Операции, в Операционной должна быть добавлена операция и отделение)

![32](/uploads/0-operac-blok/32.png "32")

Назначенная операция отобразится в электронной ИБ пациента

![33](/uploads/0-operac-blok/33.png "33")

...
Изменения параметров планирования (в т.ч. списка разделов планирования) станут видны в приложении после перезапуска серверной службы и клиентского приложения ([см. п. 3.1.2](#a22)).

...
Наряду с элементами управления отдельной строкой заявки могут быть применены инструменты массовой обработки позиций заявки,![50](/uploads/002/50.png "50")<br> представленные на панели инструментов (см. выше):   «Принять все позиции» и   «Отклонить все позиции». Например, если отклоняемых позиций меньше, чем принимаемых, <br> целесообразно сначала пометить все строки заявки с помощью кнопки <br> «Принять все позиции», а затем нужные позиции отклонить.
При обработке данных заявки можно пользоваться фильтрацией,  <br>сортировкой и поиском данных (см. подразделы настоящей главы руководства).

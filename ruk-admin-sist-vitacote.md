...
|Группа	|Поле выбора группы параметров из соответствующего справочника. Управление содержимым справочника осуществляется на форме выбора значения из справочника с помощью контекстного меню. Описание справочника [см. п. 3.5.1](#a17)|
...
Допустимые разделы планирования	|Вкладка для настройки допустимых для данного параметра разделов планирования и их значений ([см. п. 3.5.2](#a20)).|

<a name="a17"></a>
### Справочник групп параметров

Данный справочник используется для группировки параметров планирования и используется, в частности, при ведении лимитов на плановые задания ([см. п. 4](#a21)).
Содержимое справочника открывается в виде стандартной табличной формы. С помощью этой же формы осуществляется ведение справочника. При необходимости могут быть добавлены новые элементы или удалены ненужные с помощью контекстного меню строки справочника. Внешний вид формы справочника с открытым контекстным меню показан на Рис.

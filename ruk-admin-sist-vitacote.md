![3 1](/uploads/002-2/3-1.png "3 1")![59](/uploads/002/59.png "59")<!-- TITLE: Руководство администратора системы «ВИТАКОР» ОМС-Финанс-->
...
![2 2 2 2](/uploads/002-2/2-2-2-2.png "2 2 2 2") Отклонить данную позицию заявки. Нажатие кнопки помечает позицию как отклоненную, цвет ее фона становится светло-красным.
 	![2 2 2 2 2](/uploads/002-2/2-2-2-2-2.png "2 2 2 2 2") Добавить комментарий по отклоненной позиции заявки. Если данная позиция заявки отклонена, при нажатии на кнопку открывается окно для ввода комментария по позиции заявки (см. Рис. 7.3). Комментарий будет виден пользователю приложения в медицинской организации, когда он будет обрабатывать отклоненную или частично утвержденную заявку.
...
![57 1](/uploads/002/57-1.png "57 1")
...
![58 2](/uploads/002/58-2.png "58 2") Утерянный пароль не может быть восстановлен, поскольку он не хранится системой в читаемом виде. В случае необходимости администратор системы может только переустановить пароль.
...
|:------------- |:---------------:| :-------------|
| ![64 1](/uploads/002/64-1.png "64 1") Выполнить экспорт	|Панель инструментов, контекстное меню	|Запуск процедуры экспорта данных в соответствии с настройками выбранной в списке выгрузки.|
 
 
Форма редактирования выгрузки показана на рисунке ниже:

![65](/uploads/002/65.png "65")
...
| Кнопка | Описание | 
|:------------- |:---------------|
|![3 1](/uploads/002-2/3-1.png "3 1")|Кнопка добавления новой колонки в таблицу. Форма редактирования параметров колонки описана ниже.|
 |![3 2](/uploads/002-2/3-2.png "3 2")|Кнопка удаления выбранной в списке колонки.|
 |![3 3](/uploads/002-2/3-3.png "3 3")|Кнопки управления порядком следования колонок в таблице: перемещение колонки вверх на одну позицию.|
 |![3 4](/uploads/002-2/3-4.png "3 4")|Кнопки управления порядком следования колонок в таблице: перемещение колонки вниз на одну позицию.|
 
 Внешний вид формы настройки параметров колонки показан на рисунке ниже.
 
 ![67](/uploads/002/67.png "67")

...
![26](/uploads/0000001/26.png "26")

Форма обращения с жалобой: **устная** или **письменная**

Способы обращения: (Рис. 21)

![27](/uploads/0000001/27.png "27")

При необходимости заполняется поле  «регистрационный номер».

Дополнительно могут быть заполнены необязательные поля **МО** и **Условия оказания.** (Рис. 22)
 
![28](/uploads/0000001/28.png "28")

В следующих двух полях есть возможность вписать **Суть обращения** и **Принятые меры**. Текст вводится  с клавиатуры. (Рис. 23)
  
![29](/uploads/0000001/29.png "29")

Во вкладке «Рассмотрение» должен быть отмечен статус консультации после обращения. По умолчанию это поле имеет значение «В работе» (Рис. 24).
 
![30](/uploads/0000001/30.png "30")

# 	Предложения
В этом пункте предусмотрена возможность сбора и учёта возможных предложений.

По аналогии с предыдущими ранее описанными пунктами здесь существуют необходимые поля для указания. Заполнение полей во вкладке **«Застрахованный»** производится так же, как было описано в предыдущих главах руководства. На рисунке показана вкладка **«Общее»** (рис. 25):
 
![31](/uploads/0000001/31.png "31")

Форма обращения с жалобой: **устная** или **письменная**.
Способы обращения:

![32](/uploads/0000001/32.png "32")
...
![33](/uploads/0000001/33.png "33")

Перемещение производится с помощью выбора нужного пункта в выпадающем меню. Меню может быть вызвано нажатием правой клавиши мыши на требуемом элементе списка. (Ри.26)

**ВНИМАНИЕ!! УДАЛЕНИЯ ОБРАЩЕНИЯ ПОСТУПИВШЕЕ ЧЕРЕЗ CALL-CENTER - ВОЗМОЖНО ТОЛЬКО ПОД ПРАВАМИ АДМИНИСТРАТОРА. УДАЛЕНИЕ ОБРАЩЕНИЯ ПРОИСХОДИТ В ХРОНОЛОГИЧЕСКОМ ПОРЯДКЕ. -Т.Е. СПЕРВА УДАЛЯЮТСЯ ВСЕ ПРИКРЕПЛЕННЫЕ ДОКУМЕНТЫ (ЕСЛИ ТАКОВЫЕ БЫЛИ ЗАВЕДЕНЫ) И УДАЛЯЕТСЯ ОБРАЩЕНИЕ В ЭЛЕКТРОННОМ ЖУРНАЛЕ, ДАЛЕЕ ПРОИСХОДИТ УДАЛЕНИЕ ИЗ ПАПОК ЖАЛОБА-ОБРАЩЕНИЕ-КОНУЛЬТАЦИИ-ЗАПИСЬ В ЭЛЕКТРОННОМ ЖУРНАЛЕ.**
